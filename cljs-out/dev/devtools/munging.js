...
var o25593 = temp__5821__auto__;
var temp__5821__auto____$1 = (o25593["core"]);
if(cljs.core.truth_(temp__5821__auto____$1)){
var o25594 = temp__5821__auto____$1;
return (o25594["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24849__auto__ = f;
return (o__24849__auto__["toString"]).call(o__24849__auto__);
} else {
return "";
}
}catch (e25595){var _ = e25595;
return "";
}});
...
try{var o__24849__auto___25597 = t;
(o__24849__auto___25597["cljs$lang$ctorPrWriter"]).call(o__24849__auto___25597,t,writer);
}catch (e25596){var __25598 = e25596;
}
...
var char_code = (function (){var o__24849__auto__ = (new String(char$));
return (o__24849__auto__["charCodeAt"]).call(o__24849__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24849__auto__ = String;
return (o__24849__auto__["fromCharCode"]).call(o__24849__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25599 = num_code;
switch (G__25599) {
case (1):
return (185);
...
var o__24849__auto__ = String;
return (o__24849__auto__["fromCharCode"]).call(o__24849__auto__,superscript_code);
});
/**
...
}catch (e25601){var _e__24856__auto__ = e25601;
return false;
}})())){
...
var vec__25602 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25602,(0),null);
...
var len__5726__auto___25611 = arguments.length;
var i__5727__auto___25612 = (0);
while(true){
if((i__5727__auto___25612 < len__5726__auto___25611)){
args__5732__auto__.push((arguments[i__5727__auto___25612]));

var G__25613 = (i__5727__auto___25612 + (1));
i__5727__auto___25612 = G__25613;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25607){
var vec__25608 = p__25607;
var ns_detector = cljs.core.nth.call(null,vec__25608,(0),null);
...
var G__25614 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25615 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25614;
remaining_tokens = G__25615;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25605){
var G__25606 = cljs.core.first.call(null,seq25605);
var seq25605__$1 = cljs.core.next.call(null,seq25605);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25606,seq25605__$1);
}));
...
var vec__25619 = cljs.core.split_with.call(null,(function (p1__25618_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25618_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25619,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25619,(1),null);
...
var vec__25625 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25625,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25625,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25628 = cljs.core.rest.call(null,remaining_tokens);
var G__25629 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25628;
name_tokens = G__25629;
continue;
} else {
...
var vec__25632 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25632,(0),null);
var arity = cljs.core.nth.call(null,vec__25632,(1),null);
var vec__25635 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25635,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25635,(1),null);
var vec__25638 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25638,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25638,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25638,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25638,(3),null);
...
var vec__25644 = result;
var munged_ns = cljs.core.nth.call(null,vec__25644,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25644,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25644,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25644,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25644,(4),null);
var arity = cljs.core.nth.call(null,vec__25644,(5),null);
...
if(cljs.core.truth_(temp__5821__auto__)){
var vec__25648 = temp__5821__auto__;
var munged_name = cljs.core.nth.call(null,vec__25648,(0),null);
var args = cljs.core.nth.call(null,vec__25648,(1),null);
var vec__25651 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25651,(0),null);
var name = cljs.core.nth.call(null,vec__25651,(1),null);
...
var G__25654 = (arity + (1));
var G__25655 = (function (){var temp__5821__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5821__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25656){
var vec__25657 = p__25656;
var arity = cljs.core.nth.call(null,vec__25657,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25657,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25660_SHARP_){
return cljs.core.get.call(null,arities,p1__25660_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25661_SHARP_){
return cljs.core.drop.call(null,(2),p1__25661_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___25668 = arguments.length;
var i__5727__auto___25669 = (0);
while(true){
if((i__5727__auto___25669 < len__5726__auto___25668)){
args__5732__auto__.push((arguments[i__5727__auto___25669]));

var G__25670 = (i__5727__auto___25669 + (1));
i__5727__auto___25669 = G__25670;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25664){
var vec__25665 = p__25664;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25665,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25662){
var G__25663 = cljs.core.first.call(null,seq25662);
var seq25662__$1 = cljs.core.next.call(null,seq25662);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25663,seq25662__$1);
}));
...
var G__25671 = arg;
var G__25671__$1 = (((G__25671 instanceof cljs.core.Keyword))?G__25671.fqn:null);
switch (G__25671__$1) {
...
var map__25673 = options;
var map__25673__$1 = cljs.core.__destructure_map.call(null,map__25673);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25673__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25673__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25673__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25673__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25674 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25674,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25674,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25674,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25674,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25674,(4),null);
var arity = cljs.core.nth.call(null,vec__25674,(5),null);
...
var o__24849__auto__ = f;
return (o__24849__auto__["getBasis"]).call(o__24849__auto__);
});
/**
...
}catch (e25677){var _e__24856__auto__ = e25677;
...
var G__25678 = (obj[cljs.core.first.call(null,path)]);
var G__25679 = cljs.core.rest.call(null,path);
obj = G__25678;
path = G__25679;
continue;
} else {
...
var _STAR_ = (function (accum,p__25680){
var vec__25681 = p__25680;
var bit = cljs.core.nth.call(null,vec__25681,(0),null);
var protocol = cljs.core.nth.call(null,vec__25681,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25684){
var vec__25685 = p__25684;
var ns = cljs.core.nth.call(null,vec__25685,(0),null);
var name = cljs.core.nth.call(null,vec__25685,(1),null);
var selector = cljs.core.nth.call(null,vec__25685,(2),null);
...
var post_process = (function (p__25689){
var vec__25690 = p__25689;
var munged_name = cljs.core.nth.call(null,vec__25690,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25690,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25688_SHARP_){
return (obj[cljs.core.first.call(null,p1__25688_SHARP_)]);
}),sorted_matches);
