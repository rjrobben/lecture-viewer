...
var map__30340 = top_item;
var map__30340__$1 = cljs.core.__destructure_map.call(null,map__30340);
var file = cljs.core.get.call(null,map__30340__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__30340__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__30340__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e30339){var _e = e30339;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5821__auto___30341 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5821__auto___30341)){
var seen_errors_30342 = temp__5821__auto___30341;
if(cljs.core.truth_(seen_errors_30342.has(self))){
} else {
seen_errors_30342.add(self);

var temp__5823__auto___30343 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5823__auto___30343)){
var sense_30344 = temp__5823__auto___30343;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30344)].join(''));
} else {
}
}
} else {
