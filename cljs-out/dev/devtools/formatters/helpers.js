...
var G__25709 = devtools.prefs.pref.call(null,v);
v = G__25709;
continue;
} else {
return v;
...
}catch (e25710){var _e__24856__auto__ = e25710;
return false;
}})();
...
}catch (e25712){var _e__24856__auto__ = e25712;
return false;
}})();
...
}catch (e25714){var _e__24856__auto__ = e25714;
return false;
}}
}
});
...
var vec__25716 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25716,(0),null);
var name = cljs.core.nth.call(null,vec__25716,(1),null);
...
return cljs.core.some.call(null,(function (p1__25719_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25719_SHARP_);
}),template);
});
