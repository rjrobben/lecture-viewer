...
var G__21918 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21918,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21918;
}
}));
...
var len__5726__auto___21923 = arguments.length;
var i__5727__auto___21924 = (0);
while(true){
if((i__5727__auto___21924 < len__5726__auto___21923)){
args__5732__auto__.push((arguments[i__5727__auto___21924]));

var G__21925 = (i__5727__auto___21924 + (1));
i__5727__auto___21924 = G__21925;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21920){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21921,G__21922,seq21920__$2);
}));
...
var file = cljs.core.get.call(null,map__21927__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21927__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21927__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__21926_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21926_SHARP_));
...
var temp__5823__auto___21928 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___21928)){
var message_21929 = temp__5823__auto___21928;
cljs.core.println.call(null,message_21929);
} else {
}
...
var temp__5823__auto___21930 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5823__auto___21930)){
var message_21931 = temp__5823__auto___21930;
cljs.core.println.call(null,message_21931);
} else {
}
...
var output_dir__$1 = (function (){var G__21932 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__21932,"/"].join('');
} else {
return G__21932;
}
})();
...
var G__21933 = exception.stack;
var G__21933__$1 = (((G__21933 == null))?null:clojure.string.split_lines.call(null,G__21933));
var G__21933__$2 = (((G__21933__$1 == null))?null:cljs.core.get.call(null,G__21933__$1,depth));
if((G__21933__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21933__$2);
}
} else {
...
var vec__21934 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21934,(0),null);
var column = cljs.core.nth.call(null,vec__21934,(1),null);
var vec__21937 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21937,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21937,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21937,(2),null);
...
var m__$1 = (function (){var G__21940 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__21940__$1 = (((G__21940 instanceof cljs.core.Keyword))?G__21940.fqn:null);
switch (G__21940__$1) {
case "fail":
...
var G__21944 = (function (){var G__21943 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21943);
} else {
return G__21943;
}
})();
...
return cljs.core.vary_meta.call(null,G__21945,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e21946){var e = e21946;
var G__21947 = e;
var G__21947__$1 = (((G__21947 instanceof cljs.core.Keyword))?G__21947.fqn:null);
switch (G__21947__$1) {
...
var vec__21949 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21949,(0),null);
var types = vec__21949;
...
return cljs.core.map.call(null,(function (p__21952){
var vec__21953 = p__21952;
var ns = cljs.core.nth.call(null,vec__21953,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21953,(1),null);
return (function (){
...
var G__21956 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__21956__$1 = (((G__21956 instanceof cljs.core.Keyword))?G__21956.fqn:null);
switch (G__21956__$1) {
case "async":
...
var seq__21957 = cljs.core.seq.call(null,vars__$1);
var chunk__21958 = null;
var count__21959 = (0);
var i__21960 = (0);
while(true){
if((i__21960 < count__21959)){
var v = cljs.core._nth.call(null,chunk__21958,i__21960);
var temp__5823__auto___21962 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto___21962)){
var t_21963 = temp__5823__auto___21962;
each_fixture_fn.call(null,((function (seq__21957,chunk__21958,count__21959,i__21960,t_21963,temp__5823__auto___21962,v,each_fixture_fn,G__21956,G__21956__$1,env,once_fixtures,each_fixtures,vec__21953,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21963)));
});})(seq__21957,chunk__21958,count__21959,i__21960,t_21963,temp__5823__auto___21962,v,each_fixture_fn,G__21956,G__21956__$1,env,once_fixtures,each_fixtures,vec__21953,ns,vars__$1))
);
} else {
}


var G__21964 = seq__21957;
var G__21965 = chunk__21958;
var G__21966 = count__21959;
var G__21967 = (i__21960 + (1));
seq__21957 = G__21964;
chunk__21958 = G__21965;
count__21959 = G__21966;
i__21960 = G__21967;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq.call(null,seq__21957);
if(temp__5823__auto__){
var seq__21957__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21957__$1)){
var c__5525__auto__ = cljs.core.chunk_first.call(null,seq__21957__$1);
var G__21968 = cljs.core.chunk_rest.call(null,seq__21957__$1);
var G__21969 = c__5525__auto__;
var G__21970 = cljs.core.count.call(null,c__5525__auto__);
var G__21971 = (0);
seq__21957 = G__21968;
chunk__21958 = G__21969;
count__21959 = G__21970;
i__21960 = G__21971;
continue;
} else {
var v = cljs.core.first.call(null,seq__21957__$1);
var temp__5823__auto___21972__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5823__auto___21972__$1)){
var t_21973 = temp__5823__auto___21972__$1;
each_fixture_fn.call(null,((function (seq__21957,chunk__21958,count__21959,i__21960,t_21973,temp__5823__auto___21972__$1,v,seq__21957__$1,temp__5823__auto__,each_fixture_fn,G__21956,G__21956__$1,env,once_fixtures,each_fixtures,vec__21953,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21973)));
});})(seq__21957,chunk__21958,count__21959,i__21960,t_21973,temp__5823__auto___21972__$1,v,seq__21957__$1,temp__5823__auto__,each_fixture_fn,G__21956,G__21956__$1,env,once_fixtures,each_fixtures,vec__21953,ns,vars__$1))
);
} else {
}


var G__21974 = cljs.core.next.call(null,seq__21957__$1);
var G__21975 = null;
var G__21976 = (0);
var G__21977 = (0);
seq__21957 = G__21974;
chunk__21958 = G__21975;
count__21959 = G__21976;
i__21960 = G__21977;
continue;
}
} else {
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21956__$1)].join('')));
